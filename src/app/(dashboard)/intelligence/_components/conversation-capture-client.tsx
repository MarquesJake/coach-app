...
export function ConversationCaptureClient({ organizationId, contacts, coaches }: { organizationId: string; contacts: Array<{ id: string; full_name: string }>; coaches: Array<{ id: string; name: string }> }) {
