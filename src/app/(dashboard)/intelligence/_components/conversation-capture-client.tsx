...
export function ConversationCaptureClient({ organizationId, contacts, coaches, defaultCoachId, defaultContactId }: { organizationId: string; contacts: Array<{ id: string; full_name: string }>; coaches: Array<{ id: string; name: string }>; defaultCoachId?: string; defaultContactId?: string }) {
