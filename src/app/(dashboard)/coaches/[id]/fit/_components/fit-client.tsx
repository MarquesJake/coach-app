...
export function FitClient({coachId, mandates, standings = {}}: {coachId:string;mandates:{id:string;label:string}[];standings?:Record<string,string>}) {
