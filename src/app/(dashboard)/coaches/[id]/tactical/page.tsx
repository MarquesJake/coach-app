...
export default async function CoachTacticalPage(props: { params: Promise<{ id: string }> }) {
  ...
  return <div className="space-y-5"><CoachAssessment coachId={params.id} areas={['tactical_proposal', 'match_management']}/><CoachDeepDivePanel coachId={params.id} areas={['tactical_proposal', 'match_management', 'training_management', 'players_development']} /><TacticalSection coachId={params.id} coach={coach as Record<string, unknown>} /></div>
}
