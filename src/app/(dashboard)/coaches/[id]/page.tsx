...
export default async function CoachOverviewPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<ResearchParams> }) {
  ...
  return <div className="space-y-7">
    ...
    <section>
      ...
      <details className="text-xs text-muted-foreground"><summary className="w-fit cursor-pointer underline decoration-border underline-offset-4">About these figures</summary><p className="mt-2 max-w-3xl leading-relaxed">A checked source does not confirm every claim or establish suitability. {evidence.stale} records need updating.</p></details>
    </section>
