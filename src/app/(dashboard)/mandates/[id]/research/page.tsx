...
export default async function AppointmentResearchPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="mx-auto max-w-5xl space-y-5">
    ...
    <section className="gaffa-panel"><h2 className="font-semibold">Research by candidate</h2><p className="mt-1 text-sm text-muted-foreground">Check the answers and sources, or add a question for this mandate.</p>
