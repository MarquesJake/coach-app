  ...
  return (
    <section className="mt-6 border border-border bg-card">
      ...
      <div className="divide-y divide-border">
        ...
        {!claims.length && <p className="px-4 py-8 text-center text-sm text-muted-foreground">No checked findings are cleared for use yet.</p>}
      </div>
    </section>
  )
}
