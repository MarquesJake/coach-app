    ...
    <div className="mx-auto max-w-6xl px-6 py-8">
      ...
      <div className="rounded-lg border bg-card p-6 sm:p-9">
        {step === 0 && <section className="max-w-3xl space-y-5">
          ...
          <ol className="list-decimal space-y-3 pl-6"><li>Spend 5 minutes editing the club brief. What would success look like?</li><li>Spend 8 minutes checking the four candidate profiles and their sources.</li><li>Spend 7 minutes choosing comparison cases and noting missing evidence.</li><li>Spend 5 minutes reviewing and printing your board summary.</li><li>Save, refresh and sign back in to pick up where you left off.</li></ol>
          <h2 className="font-serif text-2xl">How the service works</h2><p>The club supplies the brief. An analyst clarifies it, investigates candidates and records evidence. Coaches submit their own material privately. A human reviews the evidence and approves any release.</p>
