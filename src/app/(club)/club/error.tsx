...
export default function ClubError({ reset }: { error: Error; reset: () => void }) {
  return <section role="alert" className="rounded-md border border-destructive/30 bg-card p-6">
    ...
    <p className="mt-2 text-sm text-muted-foreground">We couldn’t load your brief and access. Try again before relying on anything here or changing the brief.</p>
