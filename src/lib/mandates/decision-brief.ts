export const BRIEF_FIELDS = [
  ...
  { key: 'transition_style', step: 2, label: 'Transition style (scored)', options: ['Counter-press immediately', 'Recover shape first', 'Break quickly', 'Keep the ball'] },
  { key: 'transitions', step: 2, label: 'Transitions — detail', hint: 'When we win it and lose it: press straight away, get back into shape, break quickly or keep the ball. Free text is shown in the assessment and reports; only the choice above is scored.' },
  { key: 'development_focus', step: 2, label: 'Player development focus (scored where evidence exists)', options: ['Academy first', 'Improve the current squad', 'Grow player value', 'Not a priority'] },
  { key: 'development', step: 2, label: 'Player development — detail', hint: 'Bringing academy players through, improving the current squad or growing player value — with examples and expectations. Free text is shown in the assessment and reports; scoring needs checked evidence on the coach.' },
