...
export function MatchManagementDeepDive({ d }: { d: DeepDive }) {
  return <div className="space-y-4"><Stats items={[...d.matchManagement.stats, ...d.matchStats]} /><Block title="On matchday"><Aspects items={d.matchBehaviour} /></Block><p className={body}>{d.matchManagement.notes}</p><DeepDiveSource /></div>
}
