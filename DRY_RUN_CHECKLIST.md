...
- [ ] Open Chrome, log in, leave two tabs ready: **Tab 1** QPR Workspace, **Tab 2** Brian's board pack (backup).
- [ ] In Tab 2, click **Print / Save as PDF** once and save `Barry-Murphy-Board-Pack.pdf` to Desktop — this is your live backup artifact.
...
6. Click **Board pack →** *(top right)*
7. Scroll the dossier slowly: cover → at-a-glance → profile → timeline → findings → references → mandate context
...
- **Knutsen / Edward Still board packs** — thinner than Brian's; only open if directly asked, and frame as "earlier-stage candidates carry less evidence by design."
...
3. If the board-pack page itself won't load: the on-screen dossier in Tab 2 (already loaded pre-call) is the show — scroll it and say "and this exports to PDF for circulation."
